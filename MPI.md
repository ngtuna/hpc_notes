...
#### Gather to all
In the MPI_GATHER example, after the data are gathered into processor 0, you could then MPI_BCAST the gathered data to all of the other processors. It is more convenient and efficient to gather and broadcast with the single **MPI_ALLGATHER** operation, which will result in the following:
